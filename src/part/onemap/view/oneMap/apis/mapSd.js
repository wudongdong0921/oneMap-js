...
var createMapStatus = function(data,success) {
    ...
    return request.post({
        url: '/distributedsd/createTaskSD',
...
var getTreeData = function(data,success) {
    request.post({
        url: '/distributedsd/selectTreeInfoSD',
        loading: false,
        data: {
...
var getTreePie = function(data,success) {
    ...
    request.post({
        url: '/distributedsd/selectPieInfoSD',
        loading: false,
        data: {
            type:data.type,
            layername: data.layername, // 图层名称 (String) 必填
...
var getTreeTable = function(data,success) {
    console.log(data)
    // data.rwbmId = data.tk ? (data.rwbmId + '_TK') : data.rwbmId
    request.post({
        url: '/distributedsd/selectTableInfoListSD',
        loading: false,
        data: {
            jibie: data.jibie,
...
var executeTaskJava = function(data,success) {
    return request.post({
        url: '/distributedsd/executeTaskSD',
        devUrl: 'AnalysisServiceTest',
        data:data,
        loading: false,
        success: function (res) {
