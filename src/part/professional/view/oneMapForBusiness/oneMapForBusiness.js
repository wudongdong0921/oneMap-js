...
// 2020-12-11 09:39:03
////////////////////////////////////////////////
import OneMap from '../../../onemap/view/oneMap/component/main';//'../../oneMap/component/main';
...
export default  {
    render: function () {
        ...
        this.$api.getUserMenu({flowId: this.flowId}, (res) => {
            ...
            this.$api.openToButton({
                ...
                __OneMap._MapTools.useClearBusiness(() => {
                    _BusinessMap.searchBusinessMap(this.workId, this.flowId, __OneMap, type)
                })
                ...
                console.log(type)
                _BusinessMap.searchBusinessMap(this.workId, this.flowId, __OneMap, type)
                _BusinessMap.upMapType = type; //流程控制按钮
                //上图
                __OneMap._MapTools.handleToolUpMap((data, id, callback) => {
                    console.log(data)
                    var epsgCode = data[0].epsgCode
