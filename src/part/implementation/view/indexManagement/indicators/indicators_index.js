    ...
    render: function () {
        ...
        var _table = new icu.table({
                    ...
                    buttons: [function (unit, row, data, events) {
                        ...
                        button.click((e) => {
                            ...
                            var _dialog = implementationDialog({
                                ...
                                width: '65%',
                                height: '78%',
                                path: '/indexManagement/indicators/other_page/details',
                                params: data,
                                title: '指标项详情',
                                events: {},
                                onClose: function () {
            ...
            getEvent: function (data, setData) {
                console.log();
                if(zblxValue ==""){
                    _this.$api.zbxGetPage({
                        zblxId: zblxValue,                         // 指标类型编号
                        indexName: data.indexName,                 // 指标名
                        indexNatureCode:data.indexNatureCode,                        // 指标性质编码
        ...
        function zTreeOnClick(event, treeId, treeNode){ 
            zblxValue = treeNode.type;
            _table.reset();
        }
        var treeCity = {};
  
        _this.$api.getIndicatorTypeTree({dictType:'ZBLX'}, (res) => {
            // console.log(res);
            //tree显示
            var _data = {}; // 递归源对象
            var treeData = [];
