    ...
    render: function () {
        ...
        var _table = new icu.table({
                    ...
                    buttons: [function (unit, row, data, events) {
                        ...
                        button.click((e) => {
                            ...
                            var _dialog = implementationDialog({
                                ...
                                width: '65%',
                                height: '78%',
                                path: '/indexManagement/planning/other_page/details',
                                params: data,
                                title: '指标项详情',
                                events: {},
                                onClose: function () {
            ...
            getEvent: function (data, setData) {
                console.log(selectDictLabel);
                if(selectDictLabel == ""){
                    _this.$api.zbghGetPage({
                        xzqhId: selectDictLabel,                   // 行政区域编码
                    ...
                    _this.$api.zbghGetPage({
                        ...
                        res.data.list[i].planByv = res.data.list[i].planByv == null ? '':res.data.list[i].planByv
                        res.data.list[i].planRyv = res.data.list[i].planRyv == null ? '':res.data.list[i].planRyv
                        res.data.list[i].planTyv = res.data.list[i].planTyv == null ? '':res.data.list[i].planTyv
                        res.data.list[i].reseaseIv = res.data.list[i].reseaseIv == null ? '':res.data.list[i].reseaseIv
                        }
                        setData({
