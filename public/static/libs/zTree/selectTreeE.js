...
function initSelectTree(id, isMultiple, chkboxType, zNodes,operationType,readonly,that) {
    ...
    var html = '<div class = "layui-select-title" >' +
        '<input id="' + id + 'Show"' + 'type = "text" placeholder = "请选择人员" value = "" class = "layui-input" readonly>' +
...
function hideMenu() {
    _this.$el.find(".select-tree").removeClass("layui-form-selected");
    _this.$el.find(".tree-content").fadeOut("fast");
